...
bundled_a3b_init_traj = [read('../A3B/' + i + '/Initial_Slab.traj') 
                     for i in list_a3b_files]
write('Initial_A3B_trajs.traj', bundled_a3b_init_traj)
bundled_ab_init_traj = [read('../AB/' + i + '/Initial_Slab.traj') 
                     for i in list_ab_files]
write('Initial_AB_trajs.traj', bundled_ab_init_traj)
bundled_a3b_fin_traj = [read(glob.glob('../A3B/' + i + '/final_*.traj')[0]) 
                    for i in list_a3b_files]
write('Final_A3B_trajs.traj', bundled_a3b_fin_traj)
bundled_ab_fin_traj = [read(glob.glob('../AB/' + i + '/final_*.traj')[0]) 
                    for i in list_ab_files]
