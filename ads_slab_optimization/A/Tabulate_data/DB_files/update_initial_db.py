...
if os.path.exists('initial_A_ads_slab.db'):
    os.remove('initial_A_ads_slab.db')

db = connect('initial_A_ads_slab.db')
...
for ID in IDS:
    ...
    encoding = launch['launches'][0]['action']['stored_data']['trajectory']
