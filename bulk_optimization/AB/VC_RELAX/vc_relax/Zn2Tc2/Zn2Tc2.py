...
#SBATCH --job-name=Zn2Tc2_bulk
#SBATCH --output=Zn2Tc2_bulk.out
#SBATCH --error=Zn2Tc2_bulk.err
...
calc = espresso(pw=pw,
                ...
                calcstress=True,
                spinpol=False,
                convergence= {'energy':1e-5*13.6,    #convergence parameters
                              'mixing':0.1,
                              'nmix':10,
                              'mix':4,
                              'maxsteps':500,
