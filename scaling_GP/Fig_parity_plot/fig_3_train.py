...
for i, (ads1, ads2) in enumerate(adsorbates_pair):
    ...
    ax = plt.subplot(3, 2, i+1, aspect='equal')
    ...
    xx = data['y_train']
    yy = data['y_pred_train']
    yy_un = data['y_pred_train_uncertainty']
    if ads2 == 'CH3':
...
plt.savefig('delta_train_parity.eps', transparent=True, dpi=1500)
plt.show()
