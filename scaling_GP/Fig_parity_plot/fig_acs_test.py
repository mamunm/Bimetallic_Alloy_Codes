...
for i, (ads1, ads2) in enumerate(adsorbates_pair):
    ...
    with open(f"../main_MS_sc_GP/gp_scaling_{ads1}_{ads2}/out.txt", "r") as f:
        for line in f:
    ...
    data = np.load(f"../main_MS_sc_GP/gp_scaling_{ads1}_{ads2}/{ads2}_rsdata.npy")[()][42]
...
plt.savefig('delta_acs_parity.eps', transparent=True, dpi=1500)
plt.show()
